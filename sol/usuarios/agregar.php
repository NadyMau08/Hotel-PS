...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nombre) || empty($usuario) || empty($clave) || empty($rol)) {
        ...
        $check_query = "SELECT * FROM users WHERE usuario = '$usuario'";
        ...
        if (mysqli_num_rows($check_result) > 0) {
            ...
            // Insert new user
            $insert_query = "INSERT INTO users (nombre, usuario, clave, rol) VALUES ('$nombre', '$usuario', '$clave', '$rol')";
...
<head>
    ...
    <title>Agregar Usuario - Hotel Puesta del Sol</title>
    <!-- Bootstrap 5 CSS -->
