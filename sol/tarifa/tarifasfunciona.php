...
// Obtener agrupaciones para el formulario
$query_agrupaciones = "SELECT id, nombre, descripcion FROM agrupaciones ORDER BY nombre ASC";
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="agrupacionCrear">Agrupación</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                ...
                <form id="formEditarTarifa">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <select class="form-control" id="agrupacionEditar" name="id_agrupacion" required>
                                        <option value="">Seleccionar Agrupación</option>
                                        <?php mysqli_data_seek($result_agrupaciones, 0); ?>
                                        <?php while ($agrupacion = mysqli_fetch_assoc($result_agrupaciones)): ?>
                                            <option value="<?php echo $agrupacion['id']; ?>">
                                    ...
                                    <label for="agrupacionEditar">Agrupación</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <select class="form-control" id="temporadaEditar" name="id_temporada" required>
                                        <option value="">Seleccionar Temporada</option>
                                        <?php mysqli_data_seek($result_temporadas, 0); ?>
                                        <?php while ($temporada = mysqli_fetch_assoc($result_temporadas)): ?>
                                            <option value="<?php echo $temporada['id']; ?>">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" id="personasMinEditar" name="personas_min" min="1" required>
                                    <label for="personasMinEditar">Personas Mínimas</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" id="personasMaxEditar" name="personas_max" min="1" required>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#formCrearPorTipo').submit(function(e) {
                ...
                if (!validatePersonas('#personasMinPorTipoCrear', '#personasMaxPorTipoCrear')) {
                    return;
                }
                
                Swal.fire({
                    title: '¿Crear tarifas masivas?',
                    text: "Se crearán tarifas para todas las agrupaciones del tipo de habitación seleccionado",
                    icon: 'question',
