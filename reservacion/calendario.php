...
.tipo-cortesia{
   background: linear-gradient(135deg, #bdae56ff 0%, #c6b86dff 100%) !important;
   color: white !important;
   padding: 4px 8px;
   border-radius: 6px;
   font-weight: bold;
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                ...
                                <span class="badge tipo-cortesia">Cortesia</span>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
...
if (bloqueReserva) {
 const tipoClass = {
    walking: 'tipo-walking',
    previa: 'tipo-previa',
    cortesia: 'tipo-cortesia'
}[bloqueReserva.tipo] || 'tipo-default';
                ...
                Swal.fire({
                    ...
                    html: `
                        <div class="text-start">
                            ...
                            <p><strong>Tipo de Reserva:</strong> <span class="badge${reserva.tipo_reserva === 'walking' 
    ? 'tipo-walking' 
    : (reserva.tipo_reserva === 'previa' 
        ? 'tipo-previa' 
        : 'tipo-cortesia')}
">${reserva.tipo_reserva}</span></p>
